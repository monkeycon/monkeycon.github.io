...
var AppComponent = (function () {
    function AppComponent() {
        ...
        this.showUs = false;
        this.showIndex = true;
        this.lignNum = ['0', '1', '2', '3', '4'];
        this.colNum = ['0', '1', '2'];
        this.imgUrl = 'src/images/';
        this.imgPng = '.png';
        this.showYears = true;
